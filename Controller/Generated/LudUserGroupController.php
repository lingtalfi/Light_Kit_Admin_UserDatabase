...
class LudUserGroupController extends RealGenController
{
    ...
    {
        return $this->renderAdminPage('Light_Kit_Admin_UserDatabase/kit/zeroadmin/generated/lud_user_group_list', [], PageConfUpdator::create()->updateWidget("body.light_realist", [
            'vars' => [
                'request_declaration_id' => 'Light_Kit_Admin_UserDatabase:generated/lud_user_group',
            ],
        ]));
    }
    ...
    public function renderForm()
    {
        ...
        $identifier = "Light_Kit_Admin_UserDatabase.generated/lud_user_group";
        ...
        // RENDERING
        //--------------------------------------------
        return $this->renderAdminPage('Light_Kit_Admin_UserDatabase/kit/zeroadmin/generated/lud_user_group_form', [
