...
class LudPermissionGroupHasPermissionController extends RealGenController
{
    ...
    {
        return $this->renderAdminPage('Light_Kit_Admin_UserDatabase/kit/zeroadmin/generated/lud_permission_group_has_permission_list', [], PageConfUpdator::create()->updateWidget("body.light_realist", [
            'vars' => [
                'request_declaration_id' => 'Light_Kit_Admin_UserDatabase:generated/lud_permission_group_has_permission',
            ],
        ]));
    }
    ...
    public function renderForm()
    {
        ...
        $identifier = "Light_Kit_Admin_UserDatabase.generated/lud_permission_group_has_permission";
        ...
        // RENDERING
        //--------------------------------------------
        return $this->renderAdminPage('Light_Kit_Admin_UserDatabase/kit/zeroadmin/generated/lud_permission_group_has_permission_form', [
