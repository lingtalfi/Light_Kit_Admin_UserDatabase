...
LightKitAdminUserDatabaseService::uninstall
================



LightKitAdminUserDatabaseService::uninstall — Uninstalls the plugin.
...
public [LightKitAdminUserDatabaseService::uninstall](https://github.com/lingtalfi/Light_Kit_Admin_UserDatabase/blob/master/doc/api/Ling/Light_Kit_Admin_UserDatabase/Service/LightKitAdminUserDatabaseService/uninstall.md)() : void
...
Source Code
===========
See the source code for method [LightKitAdminUserDatabaseService::uninstall](https://github.com/lingtalfi/Light_Kit_Admin_UserDatabase/blob/master/Service/LightKitAdminUserDatabaseService.php#L73-L78)
...
Previous method: [install](https://github.com/lingtalfi/Light_Kit_Admin_UserDatabase/blob/master/doc/api/Ling/Light_Kit_Admin_UserDatabase/Service/LightKitAdminUserDatabaseService/install.md)<br>Next method: [isInstalled](https://github.com/lingtalfi/Light_Kit_Admin_UserDatabase/blob/master/doc/api/Ling/Light_Kit_Admin_UserDatabase/Service/LightKitAdminUserDatabaseService/isInstalled.md)<br>
