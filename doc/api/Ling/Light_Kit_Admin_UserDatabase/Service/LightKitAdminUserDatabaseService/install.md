...
LightKitAdminUserDatabaseService::install
================



LightKitAdminUserDatabaseService::install — Installs the plugin in the light application.
...
public [LightKitAdminUserDatabaseService::install](https://github.com/lingtalfi/Light_Kit_Admin_UserDatabase/blob/master/doc/api/Ling/Light_Kit_Admin_UserDatabase/Service/LightKitAdminUserDatabaseService/install.md)() : void
...
Source Code
===========
See the source code for method [LightKitAdminUserDatabaseService::install](https://github.com/lingtalfi/Light_Kit_Admin_UserDatabase/blob/master/Service/LightKitAdminUserDatabaseService.php#L62-L67)
...
Previous method: [setContainer](https://github.com/lingtalfi/Light_Kit_Admin_UserDatabase/blob/master/doc/api/Ling/Light_Kit_Admin_UserDatabase/Service/LightKitAdminUserDatabaseService/setContainer.md)<br>Next method: [uninstall](https://github.com/lingtalfi/Light_Kit_Admin_UserDatabase/blob/master/doc/api/Ling/Light_Kit_Admin_UserDatabase/Service/LightKitAdminUserDatabaseService/uninstall.md)<br>
